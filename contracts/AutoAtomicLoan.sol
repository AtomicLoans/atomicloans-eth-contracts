...
contract AutoAtomicLoan {
    ...
    bytes32 public secretHashAutoB1;
    bytes32 public secretHashAutoB2;
    ...
    bytes32[3] public lenderAutoSignature;
    ...
    constructor (
        ...
        bytes32[2] memory _secretHashesB_Auto,
        ...
        secretHashAutoB1 = _secretHashesB_Auto[0];
        secretHashAutoB2 = _secretHashesB_Auto[1];
    ...
    function approve () public {
        ...
        require(msg.sender == lender || msg.sender == lenderAuto);
        approved = true;
    }
    ...
    function provideSignature (bytes32[3] memory _signature) public {
        ...
        if (msg.sender == borrower) {
            ...
            lenderAutoSignature[0] = _signature[0];
            lenderAutoSignature[1] = _signature[1];
            lenderAutoSignature[2] = _signature[2];
        } else {
            revert();
        }
    }
    ...
    function provideSecret (bytes32 _secret) public {
        ...
        if (msg.sender == borrower) {
            ...
            require(sha256(abi.encodePacked(_secret)) == secretHashAutoB2);
            secretAutoB2 = _secret;
    ...
    function refundBid () public {
        ...
        require(!(sha256(abi.encodePacked(secretC)) == secretHashC && sha256(abi.encodePacked(secretA2)) == secretHashA2 && (sha256(abi.encodePacked(secretB2)) == secretHashB2 || sha256(abi.encodePacked(secretAutoB2)) == secretHashAutoB2)));
